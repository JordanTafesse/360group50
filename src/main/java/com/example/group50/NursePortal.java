...
public class NursePortal extends Application
{
    ...
    public void start(Stage primaryStage)
    {
        ...
        addGrid.getChildren().addAll(addPatientLabel, nameBox, lnameBox, addressBox, pharmaBox, ageBox, btnBox);
        ...
        loginButton.setOnAction(e -> {
            ...
            for(User u: usersLog ) {
                if ((user.equals(u.getUsername()) == true) && (pass.equals(u.getPassword()) == true) && (u.getAccess() == 1)) {
